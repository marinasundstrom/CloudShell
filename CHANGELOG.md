...
- Collapsed shell navigation is now owned by the interactive `NavMenu`
  component, which loads the browser-cached state through `JSRuntime`, syncs
  it to user settings, and remains compact when clicking between shell views.
