...
Usage:
  ...
  cloudshell template apply <template.yaml|template.json> [--control-plane <url>] [--mode <mode>] [--start] [--host-project <path>] [--data-dir <path>] [--host-settings <path>] [--bearer-token <token>]
