...
public static class ResourceTypeIcons
{
    public static Icon FromName(string? name)
    {
        ...
        return normalized switch
        {
            ...
            "database-server" => new Icons.Regular.Size20.DatabaseMultiple(),
    ...
    private static Icon FromResourceDescriptor(string normalized) =>
        normalized switch
        {
            ...
            "application.sql-server" => new Icons.Regular.Size20.DatabaseMultiple(),
            ...
            _ when normalized.Contains("sql-server", StringComparison.Ordinal) => new Icons.Regular.Size20.DatabaseMultiple(),
            _ when normalized.Contains("database", StringComparison.Ordinal) => new Icons.Regular.Size20.DatabaseMultiple(),
            _ when normalized.Contains("sql", StringComparison.Ordinal) => new Icons.Regular.Size20.DatabaseMultiple(),
