# Docker Container Built-in Provider
...
- Type-level runtime monitoring support, with log sources authored as
  `logs.sources` attributes when a graph Docker container definition needs
  them.
