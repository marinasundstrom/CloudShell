...
public sealed class GoAppResourceTypeProvider :
    IResourceTypeProvider,
    IResourceChangeApplyProvider,
    IResourceDefinitionApplyProvider
{
    public static readonly ResourceClassId ClassId = "project";
    public static readonly ResourceTypeId ResourceTypeId = "application.go-app";
    public const string ProviderId = "applications.go-app";
    ...
    public ResourceTypeDefinition TypeDefinition { get; } = new(
        ...
        Attributes: new Dictionary<ResourceAttributeId, ResourceAttributeDefinition>
        {
            [Attributes.ProjectPath] = new(
                Required: true,
                RequiredMessage: "Go app project path is required.",
        ...
        ValueTask.FromResult(new ResourceDefinitionApplyPlan(
            ...
            [
                new(
                    ...
                    "Accept Go app definition.",
                    resource.ToDefinition()),
                new(
                    resource.EffectiveResourceId,
                    ResourceTypeId,
                    ResourceDefinitionApplyStepKind.MaterializeRuntime,
                    $"Materialize Go app resource '{resource.Name}'.")
            ],
            []));
