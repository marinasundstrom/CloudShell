...
internal static class ResourceProcessMonitoringMetricSamples
{
    public static IReadOnlyList<ResourceMetricSample> Create(
        ResourceProcessMonitoringSnapshot snapshot,
