...
public sealed class ApplicationProviderExtension : ICloudShellExtension
{
    ...
    public void Configure(ICloudShellExtensionBuilder builder)
    {
        ...
        builder.Services.TryAddSingleton<ContainerApplicationOrchestratorDeploymentPlanner>();
        ...
        builder.Services.TryAddSingleton<ContainerApplicationContainerRunCommandFactory>();
