...
public sealed class LocalHostNetworkResourceTypeProvider :
    ...
    IResourceDefinitionApplyProvider
{
    ...
    public static readonly ResourceTypeId ResourceTypeId = "cloudshell.hostNetworking.local";
        ...
        ValueTask.FromResult(new ResourceDefinitionApplyPlan(
            ...
            [
                new(
                    ...
                    "Accept local host networking definition.",
                    resource.ToDefinition()),
                new(
                    resource.EffectiveResourceId,
                    ResourceTypeId,
                    ResourceDefinitionApplyStepKind.MaterializeRuntime,
                    $"Materialize local host networking resource '{resource.Name}'.")
            ],
            []));
}
