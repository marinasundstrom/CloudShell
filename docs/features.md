...
| RabbitMQ | [RabbitMQ resources](resources/rabbitmq.md) | Local-development RabbitMQ broker bridge, AMQP and management endpoints, optional volume support, generated Resource Manager details, read-only queues/exchanges topology, and deferred specialized broker management. |
