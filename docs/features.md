...
| RabbitMQ | [RabbitMQ resources](resources/rabbitmq.md) | Local-development RabbitMQ broker bridge, AMQP and management endpoints, optional volume support, and generated Resource Manager details while specialized broker UI is deferred. |
