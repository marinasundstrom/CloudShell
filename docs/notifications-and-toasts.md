...
| Artifact upload, validation, and apply | Notification-backed | Upload/validate/apply has progress, failure diagnostics, revision targets, and resource targets. | Local upload/validation progress toasts implemented; Control Plane notification producer planned. |
