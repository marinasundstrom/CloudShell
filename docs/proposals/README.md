...
| 10 | [Storage and volume mappings](storage/volume-mappings.md) | In progress | MVP: Storage and volume mappings | Initial `ResourceVolumeMount` and container app declaration/workload projection are in place. Next work is runtime materialization, first-class volume resources, UI management, and usage monitoring. |
