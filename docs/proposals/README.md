...
| 10 | [Storage and volume mappings](storage/volume-mappings.md) | Proposed | MVP: Storage and volume mappings | Defines provider-neutral volume resources and app volume attachments so stateful services do not depend on provider-native mount syntax. |
