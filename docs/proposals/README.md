...
| 2 | [Container host abstraction](containers/container-host-abstraction.md) | In progress | MVP: Container Apps, Version 1 | Host descriptor/provider compatibility layer and shared resolver are in place. Next work is Docker Compose materialization through the resolver plus provider-owned runtime infrastructure. |
