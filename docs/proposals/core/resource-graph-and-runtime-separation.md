...
| `ProjectReferenceHost_RunsProjectsWithoutOldProviderRecords` | Proves ASP.NET Core project startup and project-to-project service discovery without old application records. |
