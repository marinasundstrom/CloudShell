...
- [ ] Project the network topology overlay into graph views from
  ...
  Environment Map now shows the overlay by default with a toggle; the Resource
  graph selector remains future work.
