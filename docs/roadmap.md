...
- Use [Resource recovery](proposals/core/resource-recovery.md) to track
  ...
  probe evaluators, generated Recovery UI, future operational notifications,
  dashboard degradation summaries, and resource-builder recovery declarations
  while keeping the Health UI wording and normal lifecycle action path.
