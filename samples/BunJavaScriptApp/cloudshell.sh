...
app_host_project="${CLOUDSHELL_APP_HOST_PROJECT:-$script_dir/AppHost/CloudShell.BunJavaScriptAppHost.csproj}"
...
app_resource_id="${CLOUDSHELL_APP_RESOURCE_ID:-application.javascript-app:bun-javascript-frontend}"
...
Commands:
  ...
  start-app      Start the Bun JavaScript app resource.
  stop-app       Stop the Bun JavaScript app resource.
  restart-app    Restart the Bun JavaScript app resource.
