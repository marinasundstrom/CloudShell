...
app_host_dir="${CLOUDSHELL_GO_CONTAINER_APP_HOST_DIR:-$script_dir/AppHost}"
...
app_resource_id="${CLOUDSHELL_APP_RESOURCE_ID:-application.container-app:go-container-api}"
...
Commands:
  ...
  start-app      Start the Go container app resource.
  stop-app       Stop the Go container app resource.
  restart-app    Restart the Go container app resource.
