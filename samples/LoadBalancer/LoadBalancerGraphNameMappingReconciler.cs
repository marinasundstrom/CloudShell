...
public sealed class LoadBalancerGraphNameMappingReconciler(
    ...
    IDnsZoneNameMappingReconciler
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            if (publishingContext.Definition.DnsNameMappings.Count == 0)
            {
                ...
                [
                    new ResourceDefinitionDiagnostic(
                        ...
                        "loadBalancer.graphNameMappingsEmpty",
            ...
            [
                new ResourceDefinitionDiagnostic(
                    ResourceDefinitionDiagnosticSeverity.Information,
                    "loadBalancer.graphNameMappingsReconciled",
                    result.Message,
                    resource.EffectiveResourceId)
            ];
        }
        catch (InvalidOperationException exception)
        {
            ...
            [
                ResourceDefinitionDiagnostic.Error(
                    "loadBalancer.graphNameMappingReconcileFailed",
                    exception.Message,
                    resource.EffectiveResourceId)
            ];
        }
    ...
    private static ResourceExposureScope ParseExposure(string? value) =>
        ...
        Enum.TryParse<ResourceExposureScope>(value, ignoreCase: true, out var exposure)
            ? exposure
