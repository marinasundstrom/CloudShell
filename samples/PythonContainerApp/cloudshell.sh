...
app_resource_id="${CLOUDSHELL_APP_RESOURCE_ID:-application.container-app:python-container-api}"
...
Commands:
  template       Print the Python-authored ResourceTemplate JSON.
  ...
  start-app      Start the Python container app resource.
  stop-app       Stop the Python container app resource.
  restart-app    Restart the Python container app resource.
