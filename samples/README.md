...
| `RoboticMowerIoT` | C# launcher authoring for a React frontend, SignalR container backend, Device Registry, and a standalone simulated mower device. | IoT launcher sample with enrolled device control. |
